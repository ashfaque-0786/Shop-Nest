...
const Login = () => {
  ...
  return (
    <div className="my-20 bg-slate-100 border border-gray-200 rounded-xl shadow-xl dark:bg-neutral-900 dark:border-neutral-700 max-w-[35%] mx-auto ">
            ...
            <div className="grid gap-y-4">
              ...
              <div>
                ...
                {loginForm.touched.email && loginForm.errors.email && (
                  <p className="text-xs mt-2 text-red-600 " id=" email-error">
